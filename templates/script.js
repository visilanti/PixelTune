...
function updateOutputFileName() {
    var outputFileInput = document.getElementById('outputFile');
    var uploadInput = document.getElementById('uploadFile');
       ...
       if (uploadInput.files.length > 0) {
        ...
        // Mengatur nilai input teks output file dengan nama file yang dipilih
        outputFileInput.value = fileName;
    } else {
        // Jika tidak ada file yang dipilih, atur nilai input teks output file menjadi kosong
